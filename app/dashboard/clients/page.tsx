  ...
  return (
    <main className="admin-shell px-5 py-7 md:px-8 md:py-10">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <header className="lux-panel rounded-[2.4rem] p-6 md:p-8"><p className="lux-label">Cliente</p><h1 className="editorial-title mt-4 text-5xl leading-[0.92] md:text-7xl">Client Manager</h1><p className="mt-5 max-w-2xl text-sm leading-7 text-[var(--muted)] md:text-base">Conturi, vizite, activări, notițe private, inspirații și reward-uri.</p></header>
        <div className="mt-8"><ClientManager mode="clients" /></div>
      </div>
    </main>
  );
}
